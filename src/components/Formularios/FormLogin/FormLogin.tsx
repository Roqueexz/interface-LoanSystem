...
export default function FormLogin() { // Renomeado para combinar com o seu arquivo
  ...
  return (
    <div className="min-height-screen flex items-center justify-center bg-linear-to-br from-slate-50 to-indigo-50 p-4 min-h-screen">
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-soft border border-slate-100 animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-slate-900 tracking-tight">LoanSystem</h2>
        ...
        {erro && (
          <div className="mb-5 animate-slide-in">
            <Message severity="error" text={erro} className="w-full justify-start p-3" />
          </div>
        )}
